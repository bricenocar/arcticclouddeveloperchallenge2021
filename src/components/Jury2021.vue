          ...
          <div class="row">
            ...
            <div class="judgeCard col-md-4">
              <div class="judgeContent">
                ...
                <div class="judgeDescription">
                  <p>Mikael is a Principal Program Manager at Microsoft working on Microsoft Search (with a license to develop 🙂)

He was awarded MVP in Office Apps & Services between 2011-2018 and has authored three books on search. He is also a member of Microsoft 365 Patterns and Practices (PnP).

Closing on 50 he claims to still be youthful and humble - statements we'll just leave at that.</p>
                </div>
              </div>
            </div>
            <div class="judgeCard col-md-4">
